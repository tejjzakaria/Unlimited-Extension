...
class Ai1wmoe_Export_OneDrive {

	public static function execute( $params, Ai1wmoe_OneDrive_Client $onedrive = null ) {

		// Set progress
		Ai1wm_Status::info( __( 'Connecting to OneDrive...', AI1WMOE_PLUGIN_NAME ) );
		...
		// Get folder ID
		$params['folder_id'] = get_option( 'ai1wmoe_onedrive_folder_id', false );
		...
		// Set progress
		Ai1wm_Status::info( __( 'Done connecting to OneDrive.', AI1WMOE_PLUGIN_NAME ) );
