			...
			<?php if ( $token ) : ?>
				<div id="ai1wmoe-backups" class="ai1wm-holder">
					...
					<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php?action=ai1wmoe_onedrive_settings' ) ); ?>">
						...
						<article class="ai1wmoe-article">
							<h3><?php _e( 'Security settings', AI1WMOE_PLUGIN_NAME ); ?></h3>
							<p>
								<label for="ai1wmoe-onedrive-lock-mode">
									<input type="checkbox" id="ai1wmoe-onedrive-lock-mode" name="ai1wmoe_onedrive_lock_mode" <?php echo empty( $lock_mode ) ? null : 'checked'; ?> />
									<?php printf( __( 'Lock this page for all users except <strong>%s</strong>. <a href="https://help.servmask.com/knowledgebase/lock-settings-page/" target="blank">More details</a>', AI1WMOE_PLUGIN_NAME ), $user_display_name ); ?>
								</label>
							</p>
						</article>
